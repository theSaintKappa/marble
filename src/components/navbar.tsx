...
export default function Navbar() {
    ...
    return (
        <div className="absolute z-20 container overflow-hidden">
            <nav className="flex items-center justify-between p-6 border-2 border-dashed border-primary border-t-0 rounded-b-2xl bg-background">
